...
import { DisplayInfo } from "@calcom/web/modules/settings/components/DisplayInfo";
...
const ProfileView = ({ user }: Props) => {
  ...
  // Company email alert removed (EE organization feature)
  const shouldShowCompanyEmailAlert = false;
